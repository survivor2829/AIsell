...
def test_poll_connection_failure_is_outcome_unknown_without_resubmit(monkeypatch):
    calls = []
    ...
    assert calls == ["https://provider.invalid/v1/tasks/task-uncertain-1?language=en"]
