...
const workflowPolicies = Object.freeze({
  ...
  retry_skipped_selection_invalid: { classification: "recoverable", attentionScope: "task" },
  retry_skipped_task_mismatch: { classification: "recoverable", attentionScope: "task" },
  retry_skipped_outcome_unknown_forbidden: { classification: "blocker", attentionScope: "task" },
  retry_skipped_sent_verified_forbidden: { classification: "blocker", attentionScope: "task" },
  ...
  workflow_paused: { classification: "environment", attentionScope: "task" },
  ...
  touch_part_outcome_unknown: { classification: "blocker", attentionScope: "global" },
  moments_workflow_failed: { classification: "blocker", attentionScope: "global" },
  image_driver_exception: { classification: "blocker", attentionScope: "global" },
  image_driver_failed: { classification: "blocker", attentionScope: "global" },
  image_attempt_context_missing: { classification: "blocker", attentionScope: "task" },
  image_attempt_changed: { classification: "blocker", attentionScope: "global" },
  image_previous_outcome_unknown: { classification: "blocker", attentionScope: "global" },
  image_receipt_unavailable: { classification: "blocker", attentionScope: "global" },
  message_bubble_stale: { classification: "blocker", attentionScope: "global" },
  touch_image_changed: { classification: "blocker", attentionScope: "task" },
  moments_publish_snapshot_changed: { classification: "blocker", attentionScope: "task" },
  moments_comment_duplicate_visual_state_unknown: { classification: "blocker", attentionScope: "task" },
  moments_render_pane_ambiguous: { classification: "environment", attentionScope: "task" },
  moments_render_pane_not_found: { classification: "environment", attentionScope: "task" },
  moments_surface_read_failed: { classification: "environment", attentionScope: "task" },
  powershell_failed: { classification: "environment", attentionScope: "global" },
  powershell_output_invalid: { classification: "blocker", attentionScope: "global" },
  powershell_timeout: { classification: "environment", attentionScope: "global" },
  wechat_operation_failed: { classification: "blocker", attentionScope: "global" },
