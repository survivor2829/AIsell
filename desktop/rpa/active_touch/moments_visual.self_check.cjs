...
assert.match(script, /Get-UniqueStableVisualCandidates \$firstRead\.interactionPosts \$secondRead\.interactionPosts "post"/u);
assert.match(script, /Get-UniqueStableVisualCandidates \$firstRead\.interactionPosts \$secondRead\.posts "post_geometry"/u);
...
assert.match(script, /Get-MomentsVisualReadingCandidates \$firstFrame \$firstViewport\.bounds \$firstReadingAvatars/u);
...
assert.match(script, /Get-MomentsVisualReadingCandidates \$secondFrame \$secondViewport\.bounds \$secondReadingAvatars/u);
