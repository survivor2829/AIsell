...
app.whenReady().then(async () => {
  ...
  if (app.getVersion() === "0.1.0") logger.event("smoke", "controlled_failure", { message: "PRIVATE_CUSTOMER_TEST", apiKey: "sk-NEVER_UPLOAD_TEST", filePath: "C:/Users/private" }, { level: "error", code: "smoke_failure" });
